...
-- DEPARTMENT 테이블 복사(컬럼명, 테이터타입, NOT NULL만 복사)
...
-- 컬럼수정
-- ALTER TABLE 테이블명 MODIFY 컬럼명 테이터타입; -> 테이터 타입 변경
...
-- DEPT_ID에 D10 개발1팀 추가
INSERT INTO DEPT_COPY 
VALUES('D10', '개발1팀', 'L1', DEFAULT, DEFAULT);
-- ORA-12899: value too large for column "KH"."DEPT_COPY"."DEPT_ID" (actual: 3, maximum: 2)

-- DEPT_ID 컬럼 수정
ALTER TABLE DEPT_COPY MODIFY DEPT_ID VARCHAR2(3);


-- LNAME의 기본값을 '한국' 에서 'KOREA'로 수정
...
-- 1) 자식 , 부모 테이블 순서로 삭제 
-- 2) ALTER를 이용해서 FK 제약조건 삭제 후 TB1삭제
