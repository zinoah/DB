...
VALUES( 900, '장채현', '901123-1080503', 'jang_ch@kh.or.kr', '01055569512', 'D1', 'J8', 'S3', 
           4300000, 0.2, '200', SYSDATE, NULL, 'N') ; --실행 할때마다 값 추가 

SELECT * FROM EMPLOYEE2
WHERE EMP_ID = 900; -- 장채현이 추가 되었음 ! 

ROLLBACK; -- 이전시점으로 돌아가는

DELETE FROM EMPLOYEE2
WHERE EMP_ID = 900;


COMMIT;--커밋을하면 롤백을 해도 돌아가지 않는다 .
...
-- 테이블에 내가 선택한 컬럼에 대한 값만 INSET 할때 사용한다
...
--서브쿼리용 SELECT 구문
-- 이 SELECT 구문을 그대로 INSERT 구무을 통해서 
...
-- 급여와 보너스율은 유재식 사원과 동일하게 변경해 주기로 했따.
-- 이름 반영하는 UPDATE문을 작성하시오.
